	...
	return func(c convey.C) {
		...
		c.Convey("delete object", func(c convey.C) {
			...
			c.Convey("success to delete object", func(c convey.C) {
				...
				commitWip(ctx, c, client, uuid.New().String(), userName, repoName, refName)
		...
		uploadObject(ctx, c, client, userName, repoName, refName, "a/m.dat")
		uploadObject(ctx, c, client, userName, repoName, refName, "a/b.dat")
		uploadObject(ctx, c, client, userName, repoName, refName, "b.dat")
		uploadObject(ctx, c, client, userName, repoName, refName, "c.dat")
