...
func GetEntriesInRefSpec(ctx context.Context, urlStr string) func(c convey.C) {
	...
	return func(c convey.C) {
		...
		uploadObject(ctx, c, client, userName, repoName, refName, "m.dat")
		uploadObject(ctx, c, client, userName, repoName, refName, "g/x.dat")
		uploadObject(ctx, c, client, userName, repoName, refName, "g/m.dat")
		...
		commitWip(ctx, c, client, "commit kitty first changes", userName, repoName, refName)
		...
		uploadObject(ctx, c, client, userName, repoName, "main", "a.dat")   //delete\
		uploadObject(ctx, c, client, userName, repoName, "main", "g/m.dat") //modify
		commitWip(ctx, c, client, "commit branch change", userName, repoName, "main")
