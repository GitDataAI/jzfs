...
impl WebSession {
    pub fn set_session(req: &mut ServiceRequest, data: impl IntoIterator<Item = (String, String)>) -> anyhow::Result<()> {
    ...
    pub fn get_changes<B>(res: &mut ServiceResponse<B>) -> (SessionStatus, DashMap<String,String>) {
