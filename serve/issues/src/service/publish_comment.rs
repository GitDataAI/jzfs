...
impl AppIssueService { 
    pub async fn service_publish_comment(&self, param: IssueCommentCreateParam,repo_uid:Uuid,user_id:Uuid,issue_id:i32)-> AppResult<comment::Model>{
