...
use crate::schema::{IssueCreateParam, IssueFetchParam, IssueCommentUpdateParam, IssueLabelDeleteParam, IssueUpdateParam, IssueCommentCreateParam, IssueSubscribeParam, IssueStatusUpdateParam, IssueAssigneeUpdateParam, IssueLabelUnlinkParam, IssueLabelLinkParam, IssueLabelCreateParam, LabelCreateParam};
use issuesd::{ issues,label,comment,issue_labels,issue_sub } ;
use crate::service::update_label::LabelUpdateParam;
...
pub trait IssueInterFace {
    ...
    async fn create_label(param: LabelCreateParam)-> AppResult<label::Model>;
    async fn update_label(param: LabelUpdateParam)-> AppResult<label::Model>;
