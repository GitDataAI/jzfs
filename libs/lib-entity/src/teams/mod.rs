...
mod tests {
    ...
    async fn teams_sql() {
        ...
        result.push(teams::TeamsMigration::create().to_string(PostgresQueryBuilder {}));
        result.push(teamsus::TeamUsMigration::create().to_string(PostgresQueryBuilder {}));
        result.push(teaminv::TeamInvMigration::create().to_string(PostgresQueryBuilder {}));
        result.push(teamrepo::TeamRepoMigration::create().to_string(PostgresQueryBuilder {}));
        for i in result {
            println!("{}", i);
        }
    }
