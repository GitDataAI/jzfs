...
impl GroupsMigration {
    pub fn create() -> sea_orm_migration::prelude::TableCreateStatement {
        sea_orm_migration::prelude::Table::create()
            ...
            .col(sea_orm_migration::prelude::ColumnDef::new(GroupsMigration::Bio).string())
            .col(
                sea_orm_migration::prelude::ColumnDef::new(GroupsMigration::Pronouns)
                    .string()
                    .not_null(),
            )
            .col(sea_orm_migration::prelude::ColumnDef::new(GroupsMigration::Company).string())
            .col(sea_orm_migration::prelude::ColumnDef::new(GroupsMigration::Location).string())
            .col(sea_orm_migration::prelude::ColumnDef::new(GroupsMigration::Localtime).string())
            .col(sea_orm_migration::prelude::ColumnDef::new(GroupsMigration::I18n).string())
            .col(
                sea_orm_migration::prelude::ColumnDef::new(GroupsMigration::Website)
                    .array(sea_orm_migration::prelude::ColumnType::Text),
            )
            .col(sea_orm_migration::prelude::ColumnDef::new(GroupsMigration::Orcid).string())
            .col(
            ...
            .col(sea_orm_migration::prelude::ColumnDef::new(GroupsMigration::AvatarUrl).string())
            .col(
