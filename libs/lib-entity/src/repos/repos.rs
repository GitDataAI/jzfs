...
use crate::repos::branchs;
use crate::repos::labels;
use crate::repos::license;
...
impl ActiveModel {
    pub fn new(
        ...
        ActiveModel {
            ...
            is_group : ActiveValue::Set(false),
            has_issues : ActiveValue::Set(true),
            has_idcard : ActiveValue::Set(true),
            has_wiki : ActiveValue::Set(true),
            has_downloads : ActiveValue::Set(true),
            has_projects : ActiveValue::Set(true),
            topic : ActiveValue::Set(vec![]),
            collaborators : ActiveValue::Set(vec![]),
            default_branchs : ActiveValue::Set(default_branch),
            nums_star : ActiveValue::Set(0),
            nums_fork : ActiveValue::Set(0),
            nums_watcher : ActiveValue::Set(0),
            nums_commit : ActiveValue::Set(0),
            nums_release : ActiveValue::Set(0),
            nums_tag : ActiveValue::Set(0),
            nums_branchs : ActiveValue::Set(0),
            nums_members : ActiveValue::Set(0),
            fork : ActiveValue::Set(false),
            fork_from : ActiveValue::Set(None),
            created : ActiveValue::Set(chrono::Local::now().timestamp()),
            updated : ActiveValue::Set(chrono::Local::now().timestamp()),
            node : ActiveValue::Set(node),
        }
    }
}
...
impl ReposMigration {
    pub fn create() -> sea_orm_migration::prelude::TableCreateStatement {
        sea_orm_migration::prelude::Table::create()
            ...
            .col(
                sea_orm_migration::prelude::ColumnDef::new(ReposMigration::Node)
                    .uuid()
                    .not_null(),
            )
            .take()
