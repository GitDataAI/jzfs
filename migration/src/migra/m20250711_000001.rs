...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        db.execute_unprepared("DROP TABLE IF EXISTS issue_labels;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS comment;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS issue_sub;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS org_repo;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS user_repo;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS org_team;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS watch;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS stars;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS follow;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS git_branch;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS git_commit;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS git_code;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS git_data;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS git_model;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS git_repo_nums;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS contributors;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS label;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS issues;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS repository;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS blacklist;").await?;

        db.execute_unprepared("DROP TABLE IF EXISTS users;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS security;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS ssh;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS access_key;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS org;").await?;
        db.execute_unprepared("DROP TABLE IF EXISTS org_member;").await?;
...
CREATE TABLE IF NOT EXISTS git_code (
     ...
     CREATE TABLE IF NOT EXISTS label (
        ...
        CREATE TABLE IF NOT EXISTS issues (
                                      ...
                                      assignee_uid UUID[] NOT NULL DEFAULT '{}',
                                      status TEXT NOT NULL,
    ...
    "theme" TEXT,
    "location" TEXT,
    "topic" TEXT[] NOT NULL DEFAULT ARRAY[]::TEXT[],
    "setting" TEXT[] NOT NULL DEFAULT ARRAY[]::TEXT[],
