...
// RegisterHasher allows for the hash algorithm used to be overridden.
// This ensures the hash selection for go-git must be explicit, when
// overriding the default value.
func RegisterHasher(h crypto.Hash, f func() hash.Hash) error {
	if f == nil {
...
// Hasher is the same as hash.Hash. This allows consumers
